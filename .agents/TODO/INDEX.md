...
| Slug | Title | Status | Updated | Depends |
|------|-------|--------|---------|---------|
| [worktree-bridge-tab](worktree-bridge-tab.md) | Worktree bridge tab in unified dashboard (lazy-llm ↔ worktree view + cleanup) | pending | 2026-05-13 | unified-llm-dashboard, worktree-per-task-primitive |
| [dense-keybindings-popup-scopes](dense-keybindings-popup-scopes.md) | Dense single-letter keybindings within lazy-llm popups (replace Ctrl+ chords) | pending | 2026-05-13 | — |
